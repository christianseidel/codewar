...
import codewars.White.FindNeedle;
...
class FindNeedleTest {
    ...
    @Test
    public void myTest() {
        Object[] haystack0 = {"einzweidrei", "needle", "dreivierfünf"};

        System.out.println(FindNeedle.findNeedle(haystack0));
    }
    ...
    @Test
    public void findAtPositionSix() {
        Object[] haystack = {"hay", "junk", "hay", "hay", "moreJunk", "needle", "randomJunk"};
        assertEquals("found the needle at position 5", FindNeedle.findNeedle(haystack));
    }
